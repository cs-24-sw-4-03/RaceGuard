...
import org.abcd.examples.ParLang.ParLangLexer;
...
//PARSER TEST------------------------------------------------------------------------------------------------
    ...
    public void testLexerTypes() {
        ...
        for(org.antlr.v4.runtime.Token token : tokenList){
            assertEquals(token.getText(),ParLangLexer.VOCABULARY.getDisplayName(token.getType()).replaceAll("'", ""));
        }
    }
    ...
    public void testLexerprimitivesAndIdentifier() {
        ...
        for(org.antlr.v4.runtime.Token token : tokenList){
            switch (counter){
                case 0:
                    assertEquals(ParLangLexer.VOCABULARY.getDisplayName(token.getType()),"INT");
                    break;
                case 1: {
                    assertEquals(ParLangLexer.VOCABULARY.getDisplayName(token.getType()),"DOUBLE");
                    break;
                }
                case 2: {
                    assertEquals(ParLangLexer.VOCABULARY.getDisplayName(token.getType()),"STRING");
                    break;
                }
                case 3: {
                    assertEquals(ParLangLexer.VOCABULARY.getDisplayName(token.getType()),"IDENTIFIER");
                    break;
                }
            }
            counter++;
    ...
    public void testLexerCommentAndWhitespace() {
        ...
        assertEquals(token.getText().replaceAll("<","").replaceAll(">",""), ParLangLexer.VOCABULARY.getSymbolicName(token.getType()));
    }
    ...
    public void testLexerSingleQuote() {
        ...
        org.antlr.v4.runtime.Token token = tokenList.get(0);
        assertEquals(token.getText(),ParLangLexer.VOCABULARY.getDisplayName(token.getType()).replaceFirst("''", ""));
    }
    ...
    public void testLexerDoubleQuote() {
        ...
        assertEquals(2,tokenList.size());
        org.antlr.v4.runtime.Token token = tokenList.get(0);
        assertEquals("DOUBLE_QUOTATION",ParLangLexer.VOCABULARY.getDisplayName(token.getType()).replaceAll("'", ""));
    }
    ...
    public void testStringSingleQuote() {
        ...
        assertEquals(2,tokenList.size());
        org.antlr.v4.runtime.Token token = tokenList.get(0);
        assertEquals("STRING",ParLangLexer.VOCABULARY.getDisplayName(token.getType()).replaceAll("'", ""));
    }
