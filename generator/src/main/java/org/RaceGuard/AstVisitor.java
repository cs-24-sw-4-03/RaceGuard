...
public class AstVisitor extends RaceGuardBaseVisitor<AstNode> {
    ...
    @Override public AstNode visitInit(RaceGuardParser.InitContext ctx) {
    ...
    @Override public AstNode visitMainFunc(RaceGuardParser.MainFuncContext ctx) {
    ...
    @Override public AstNode visitMethodCall(RaceGuardParser.MethodCallContext ctx) {
    ...
    @Override public AstNode visitSendMsg(RaceGuardParser.SendMsgContext ctx) {
        ...
        if(receiver.equals(RaceGuardE.SELF.getValue())){
    ...
    @Override public AstNode visitParameters(RaceGuardParser.ParametersContext ctx){
    ...
    @Override public AstNode visitArguments(RaceGuardParser.ArgumentsContext ctx){
    ...
    @Override public AstNode visitScript(RaceGuardParser.ScriptContext ctx) {
    ...
    @Override public AstNode visitScriptMethod(RaceGuardParser.ScriptMethodContext ctx) {
        ...
        switch (methodType) {
            case "on": //on-methods always return void
                returnType = RaceGuardE.VOID.getValue();
                break;
    ...
    @Override public AstNode visitActor(RaceGuardParser.ActorContext ctx) {
    ...
    @Override public AstNode visitFollow(RaceGuardParser.FollowContext ctx) {
    ...
    @Override public AstNode visitActorState(RaceGuardParser.ActorStateContext ctx) {
    ...
    @Override public AstNode visitActorKnows(RaceGuardParser.ActorKnowsContext ctx) {
        int numOfChildren=ctx.getChildCount();
    ...
    @Override public AstNode visitSpawn(RaceGuardParser.SpawnContext ctx) {
    ...
    @Override public AstNode visitSpawnActor(RaceGuardParser.SpawnActorContext ctx) {
    ...
    @Override public AstNode visitStateAccess(RaceGuardParser.StateAccessContext ctx) {
    ...
    @Override public AstNode visitKnowsAccess(RaceGuardParser.KnowsAccessContext ctx){
    ...
    @Override public AstNode visitOnMethod(RaceGuardParser.OnMethodContext ctx) {
        MethodDclNode node= new MethodDclNode(ctx.identifier().getText(), RaceGuardE.VOID.getValue(), ctx.ON_METHOD().getText());
        node.setLineNumber(ctx.getStart().getLine());
        node.setColumnNumber(ctx.getStart().getCharPositionInLine());
    ...
    @Override public AstNode visitLocalMethod(RaceGuardParser.LocalMethodContext ctx) {
    ...
    @Override public AstNode visitBody(RaceGuardParser.BodyContext ctx) {
    ...
    @Override public AstNode visitPrintCall(RaceGuardParser.PrintCallContext ctx) {
    ...
    private AstNode printCallHelper(AstNode parent, RaceGuardParser.PrintBodyContext ctx){
    ...
    @Override
    public AstNode visitDeclaration(RaceGuardParser.DeclarationContext ctx) {
        ...
        RaceGuardParser.InitializationContext init=ctx.initialization(); //get the initialization value
    ...
    private String getTypeFromDclTypes(RaceGuardParser.DclTypesContext ctx){
    ...
    @Override
    public AstNode visitList(RaceGuardParser.ListContext ctx){
    ...
    @Override
    public AstNode visitAssignment(RaceGuardParser.AssignmentContext ctx) {
    ...
    @Override
    public AstNode visitIdentifier(RaceGuardParser.IdentifierContext ctx) {
    ...
    @Override public AstNode visitStatement(RaceGuardParser.StatementContext ctx) {
        return visit(ctx.getChild(0));//if statement has more than one child, the second one is ";". We just visit the  child always.
    }

    @Override public AstNode visitKillCall(RaceGuardParser.KillCallContext ctx) {
    ...
    @Override public AstNode visitArithExp(RaceGuardParser.ArithExpContext ctx) {
    ...
    private AstNode visitArithExpChild(ParseTree child, RaceGuardParser.ArithExpContext parent, int operatorIndex){
    ...
    @Override public AstNode visitTerm(RaceGuardParser.TermContext ctx) {
        int childCount= ctx.getChildCount();
    ...
    private AstNode visitTermChild(ParseTree child, RaceGuardParser.TermContext parent, int operatorIndex){
    ...
    @Override public AstNode visitFactor(RaceGuardParser.FactorContext ctx) {
    ...
    @Override public AstNode visitUnaryExp(RaceGuardParser.UnaryExpContext ctx) {
    ...
    @Override public AstNode visitNumber(RaceGuardParser.NumberContext ctx) {
    ...
    @Override public AstNode visitValue(RaceGuardParser.ValueContext ctx){
    ...
    @Override public AstNode visitWhileLoop(RaceGuardParser.WhileLoopContext ctx) {
    ...
    @Override public AstNode visitForLoop(RaceGuardParser.ForLoopContext ctx) {
    ...
    @Override public AstNode visitPrimitive(RaceGuardParser.PrimitiveContext ctx){
    ...
    @Override public AstNode visitBoolExp(RaceGuardParser.BoolExpContext ctx) {
        int childCount = ctx.getChildCount();
        if (childCount == 1) { // If there is only one child
            return visit(ctx.getChild(0)); // Visit the child
        }
    ...
    @Override public AstNode visitBoolAndExp(RaceGuardParser.BoolAndExpContext ctx) {
        int childCount = ctx.getChildCount();
        if (childCount == 1) { // If there is only one child
            return visit(ctx.getChild(0)); // Visit the child
        }
    ...
    @Override public AstNode visitBoolCompare(RaceGuardParser.BoolCompareContext ctx) {
        int numOfChildren = ctx.getChildCount();
    ...
    @Override
    public AstNode visitBoolTerm(RaceGuardParser.BoolTermContext ctx) {
    ...
    @Override
    public AstNode visitNegatedBool(RaceGuardParser.NegatedBoolContext ctx) {
    ...
    @Override
    public AstNode visitBoolLiteral(RaceGuardParser.BoolLiteralContext ctx) {
    ...
    @Override
    public AstNode visitCompareExp(RaceGuardParser.CompareExpContext ctx) {
    ...
    @Override public AstNode visitArrayAccess(RaceGuardParser.ArrayAccessContext ctx){
        //An array access
        String accessIdentifier = ctx.identifier().getText();
    ...
    @Override public AstNode visitLocalMethodBody(RaceGuardParser.LocalMethodBodyContext ctx){
    ...
    @Override public AstNode visitReturnStatement(RaceGuardParser.ReturnStatementContext ctx){
    ...
    @Override
    public AstNode visitSelection(RaceGuardParser.SelectionContext ctx) {
